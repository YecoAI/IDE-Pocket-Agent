...
class ModernAgentUI(ctk.CTk):
 ...
 text_color=Theme.TEXT_SECONDARY,
 font=ctk.CTkFont(family=Theme.FONT_MONO, size=14, weight="bold"),
 ...
 icon_ico = os.path.join(os.path.dirname(__file__), "..", "IDE_Pocket.ico")
 if os.path.exists(icon_ico):
 self.iconbitmap(icon_ico)
 else:
 icon_png = os.path.join(os.path.dirname(__file__), "..", "IDE_Pocket.png")
 ...
 "Company: YecoAI\n"
 "Website: https://idepocket.com\n\n"
 "Package: com.yecoai.idepocket\n"
 ...
 self.pairing_label = ctk.CTkLabel(
 card,
 text="Pairing Code",
 ...
 self.pairing_desc = ctk.CTkLabel(
 card,
 text="Enter the code from your mobile app",
 ...
 height=50,
 justify="center",
 font=ctk.CTkFont(family=Theme.FONT_MONO, size=24, weight="bold"),
 ...
 card,
 text="Verify Code",
 command=self.handle_pairing,
 fg_color=Theme.BRAND_GREEN,
 hover_color=Theme.BRAND_GREEN_HOVER,
 ...
 self.otp_desc = ctk.CTkLabel(
 card,
 text="Enter the 6-digit OTP from your app",
 font=ctk.CTkFont(family=Theme.FONT_FAMILY, size=12),
 text_color=Theme.TEXT_MUTED
)
 ...
 card,
 text="Confirm OTP",
 command=lambda: self.handle_otp(assoc_id),
 fg_color=Theme.BRAND_GREEN,
 hover_color=Theme.BRAND_GREEN_HOVER,
 text_color=Theme.BG_BASE,
 font=ctk.CTkFont(family=Theme.FONT_FAMILY, size=14, weight="bold"),
 ...
 if is_first_setup:
 self.phone_msg_frame = ctk.CTkFrame(
 card,
 fg_color=Theme.BG_BASE,
 corner_radius=12,
 border_width=1,
 border_color=Theme.BRAND_GREEN
)
 self.phone_msg_frame.pack(padx=30, fill="x", pady=10)
 ctk.CTkLabel(
 self.phone_msg_frame,
 text="IMPORTANT",
 ...
 ctk.CTkLabel(
 self.phone_msg_frame,
 text="Click 'Done' on your Mobile App\nto complete the setup",
 font=ctk.CTkFont(family=Theme.FONT_FAMILY, size=13, weight="bold"),
 text_color=Theme.TEXT_DEFAULT
).pack(pady=(5, 15))
 self.after(10000, self.hide_phone_message)

 bg_instructions = ctk.CTkLabel(
 card,
 text="You can now close or minimize this window.\nThe agent will continue to run in the background.",
 ...
 kill_switch_info = ctk.CTkLabel(
 card,
 text="EMERGENCY STOP: Move mouse + 5 clicks in 3s",
 font=ctk.CTkFont(family=Theme.FONT_FAMILY, size=10, weight="bold"),
 ...
 self.id_val = ctk.CTkLabel(
 info_frame,
 text=str(self.agent.current_association_id or 'N/A'),
 ...
 text=msg.upper(),
 text_color=Theme.ERROR_RED if is_error else Theme.TEXT_SECONDARY
)
 ...
 def setup_tray(self):
 try:
 icon_path = os.path.join(os.path.dirname(__file__), "..", "IDE_Pocket.png")
 ...
 self.tray_icon = pystray.Icon("ide_pocket_agent", image, "IDE Pocket Agent", menu)
 threading.Thread(target=self.tray_icon.run, daemon=True).start()

 def hide_window(self):
 self.withdraw()
 if self.tray_icon:
 self.tray_icon.notify("Agent is running in the background", "IDE Pocket Agent")
