...
class ModernAgentUI(ctk.CTk):
    ...
    def create_widgets(self):
        ...
        self.logo_label = ctk.CTkLabel(self.header_frame, text="IDE Pocket", font=ctk.CTkFont(family=Theme.FONT_FAMILY, size=32, weight="bold"), text_color=Theme.BRAND_GREEN)
        self.logo_label.pack()
        self.subtitle_label = ctk.CTkLabel(self.header_frame, text="REMOTE WORKER", font=ctk.CTkFont(family=Theme.FONT_FAMILY, size=12, weight="bold"), text_color=Theme.TEXT_SECONDARY)
