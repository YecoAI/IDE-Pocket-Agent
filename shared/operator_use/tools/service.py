...
class Tool(ABC):
 ...
 return resolve_refs(non_null_types[0])
 return[resolve_refs(t)for t in non_null_types]

 if "type"in obj and isinstance(obj["type"], list)and "null"in obj["type"]:
 new_type =[t for t in obj["type"]if t !="null"]
 obj["type"]=new_type[0]if len(new_type)==1 else new_type
